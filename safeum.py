...
texts = ['               By ScripterVyasan', '                https://github.com/vyasanbmathew']
colors = ['red', 'cyan']
...
webbrowser.open("https://t.me/scriptervyasan")
    ...
    try:
        ...
        if '"status":"Success"' in gzip:
            ...
            with open('SafeUM_HAXKX.txt', 'a') as f:
                f.write(username + ":hugg | TG : @MAH._.BOT\n")
...
while True:
    ...
    if int(success) > int(0):
        ...
        print("ACCOUNTS GENERATED>> By Scripter Vyasan\n", z)
